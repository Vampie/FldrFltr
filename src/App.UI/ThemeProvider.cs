...
namespace FldrFltr
{
    ...
    /// philosophy as Languages). §5 phase 4 ships a few editor-inspired palettes (Monokai,
    /// Solarized) this way; dropping in more/your own is just adding another file, no UI needed.
